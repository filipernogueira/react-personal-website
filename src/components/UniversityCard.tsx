...
export default function UniversityCard({ logo, name, degreeType, degree, description, duration, url } : { logo: string, name: string, degreeType: string, degree: string, description: string, duration: string, url: string }) {
  return (
