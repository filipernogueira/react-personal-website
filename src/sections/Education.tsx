...
const universities = [
  ...
  {logo: questionMark, name: "Unknown", degreeType: "PhD", degree: "Computer Science", description: "It's still an unknown, but maybe on the future, if it arises a PhD degree, it would be Artificial Intelligence or Cybersecurity related. The university that I will choose, will be somewhere in Asia or USA.", duration: "", url: ""},
]
